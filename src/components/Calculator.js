...
export default function Calculator() {
  ...
  return (
    <section id="calculator" style={{ paddingTop: '64px', paddingBottom: '0', position: 'relative', backgroundImage: 'url(/temple.jpg)', backgroundSize: '120%', backgroundPosition: 'center 20%', backgroundAttachment: 'fixed' }}>
      {/* Dark overlay */}
